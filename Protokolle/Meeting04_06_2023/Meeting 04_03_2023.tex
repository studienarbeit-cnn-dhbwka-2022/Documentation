...
%Ziele des Treffens 
    ...
    \begin{Ziele des Meetings}
        \item[Einrichten eines gemeinsamen Codespaces]
            Um optimales Pair-Programming sicherzustellen ist es nötig gemeinsam in Echtzeit an der Code-basis arbeiten zu können. 
        ...
        \item[Kick-Off des Codings]
            Ziel des Meetings ist das Aufsetzen der Entwicklungsumgebung sowie das gemeinsame Erarbeiten des ersten Code-Stücks im Pair-Programming.
    \end{Ziele des Meetings}
%Umgebung/Durchführung des Treffens 
    \section{Umsetzung des Treffens}
    Das Meeting fand bei Marc Goekce zuhause statt.
    Nach gemeinsamen Frühstück wurde sich zunaechst ueber das Aufsetzen der gemeinsamen Entwicklungsumgebung abgestimmt
