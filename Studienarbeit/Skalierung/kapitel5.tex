...
\section{Qualitätsmetriken zur Bewertung von Skalierungsmethoden}
    ...
    \subsection{Peak Signal-to-Noise Ratio (PSNR)}
        ...
        \subsubsection{Definition und Berechnung von \ac{PSNR}}
            ...
            Formel MSE: MSE = (1/(m*n))*sum(sum((f-g).^2))
...
\section{Kriterien zur Auswahl der optimalen Skalierungsmethode} %TODO Hier können wir viele Bilder einbauen um die Vergleichsgrafiken besser zu erklären (@MARC)
    ...
    \subsection{Effektivität und Effizienz}
        ...
        \footfullcite{zhang2019efficiency,gu2019comprehensive,hu2020efficient}
    ...
    \subsection{Zukunftsaussichten und Herausforderungen}
        ...
        \footfullcite{zhang2015learning,blau2018perception,liu2016ssd,zhang2018split}
\newpage