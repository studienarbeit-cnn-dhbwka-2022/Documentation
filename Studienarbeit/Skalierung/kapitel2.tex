...
\end{description}
Weiterhin gibt es unzählige Standards um Grafiken darzustellen. Diese übersteigen jedoch den Umfang dieser Arbeit.\footfullcite{prepressure_file_formats}\footfullcite{ionos_file_formats}
\subsection{Wichtige Aspekte der Skalierung}


\section{Anwendungen von Skalierungsmethoden}
% subsections können weg
